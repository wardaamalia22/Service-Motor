    ...
    <div class="content">
        <div class="card shadow-sm p-3 mb-5 bg-body rounded">
            <div class="card-body">
                ...
                <a href="{{ route('tambahkasir') }}" class="btn btn-primary">Tambah Kasir</a>
                    ...
                    <table class="table table-striped" id="example">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->alamat }}</td>
                                <td class="actions">
                                    <a href="{{ route('editkasir', $item->id) }}" class="btn btn-primary">Edit</a>
                                    <a href="{{ route('hapusKasir', $item->id) }}" class="btn btn-danger" onclick="return confirm('Yakin Mau Hapus?')">Hapus</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
