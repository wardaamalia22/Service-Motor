                        ...
                        <tbody class="text-center">
                            @foreach ($booking as $item)
                                <tr>
                                    ...
                                    <td>
                                        @if ($item->bukti && $item->bukti->foto)
                                            <img src="{{ asset($item->bukti->foto) }}" alt="Bukti Foto"
                                                class="img-thumbnail">
                                        @else
                        ...
                        <tbody class="text-center">
                            @foreach ($booking as $item)
                                <tr>
                                    ...
                                    <td>
                                        @if ($item->bukti && $item->bukti->foto)
                                        <a href="{{ asset($item->bukti->foto) }}" target="_blank">
                                            Lihat Bukti
                                        </a>
                                    @else
                                ...
                                <td>
                                    ...
                                    <td class="actions">
                                        <a href="{{ route('confirm', $item->id) }}" class="btn btn-outline-primary btn-sm">
                                            Edit <i class="bi bi-pencil-square"></i>
                                        </a>
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('tambahPesanan') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        {{-- <div class="mb-3">
                            <label for="status_orderan" class="form-label">Status Orderan</label>
                            <select name="status_orderan" class="form-select" required>
                        ...
                        {{-- <div class="mb-3">
                            ...
                            <select name="status_service" class="form-select" required>
