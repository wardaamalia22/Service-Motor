                        ...
                        <tbody class="text-center">
                            @foreach ($detail as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->booking->no_plat }}</td>
                                    <td>{{ $item->booking->jenis_service }}</td>
                                    <td>{{ $item->booking->deskripsi }}</td>
                                    <td>{{ $item->barang->nama_barang }}</td>
                                    <td>{{ number_format($item->barang->harga, 0, '.','.') }}</td>
                                    {{-- <td>{{ $item->detailtransakai->jumlah }}</td> --}}
                                    <td>{{ number_format($item->biaya_penanganan, 0, '.','.') }}</td>
                                    <td>{{ number_format($item->subtotal, 0, '.','.') }}</td>
                                    <td class="actions">
                                        <a href="{{ route('DT', $item->id) }}" class="btn btn-outline-primary">Edit <i class="bi bi-pencil-square"></i></a>
